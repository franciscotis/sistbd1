...
CREATE TABLE `Escrito` (
  ...
  `codAut` smallint(6) NOT NULL,
  PRIMARY KEY (`codT`,`codAut`),
  KEY `codAut` (`codAut`),
  CONSTRAINT `Escrito_ibfk_1` FOREIGN KEY (`codT`) REFERENCES `Titulo` (`codT`),
  CONSTRAINT `Escrito_ibfk_2` FOREIGN KEY (`codAut`) REFERENCES `Autor` (`codAut`)
